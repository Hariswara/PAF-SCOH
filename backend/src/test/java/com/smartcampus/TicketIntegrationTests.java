...
class TicketIntegrationTests {
    ...
    void createTicket_shouldReturn201() throws Exception {
        CreateTicketRequest request = new CreateTicketRequest(
                null, "Lab 401", TicketCategory.EQUIPMENT,
                "Projector lamp is broken and flickers constantly", TicketPriority.HIGH,
                "int-test@example.com", null);
    ...
    void createTicket_missingLocation_shouldReturn400() throws Exception {
        CreateTicketRequest request = new CreateTicketRequest(
                null, "", TicketCategory.EQUIPMENT,
                "Projector broken", TicketPriority.HIGH,
                "int-test@example.com", null);
